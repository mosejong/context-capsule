...
The launcher creates `.venv`, installs runtime dependencies, and starts the local dashboard at:
...
See [Local App](./docs/local_app.md) for install, run, and safety details.
