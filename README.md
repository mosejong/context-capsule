...
현재 공개 버전은 KDT 수강생/신입 개발자/면접 포트폴리오 검증용 public MVP입니다. 2026-07-06 생산성/보안 감사에서 확인된 CLI 경로 하드닝 이슈는 수정·검증했지만, `app/web` 경로와 10k+ 파일 규모 성능은 아직 별도 감사 전입니다. 상업화보다 실제 테스터 피드백과 제품 안정화를 우선합니다.
