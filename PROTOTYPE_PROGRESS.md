...
| Current | v0.2.4 tester UX polish | Clarifies result reading order, Korean graph labels, and workflow-trace feedback collection. |
...
v0.2.4 = tester UX polish for result order and graph trace feedback
```
