...
Context Capsule v0.2.0 is distributed as a GitHub Release ZIP.
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\build_release.ps1 -Version 0.2.0 -DryRun
```
...
```text
Download context-capsule-v0.2.0.zip
Extract
...
- [ ] `scripts/build_release.ps1 -Version 0.2.0` creates the ZIP.
...
- v0.2.0 is not a single executable.
