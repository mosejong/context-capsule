...
Context Capsule v0.1.0 is distributed as a GitHub Release ZIP.
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\build_release.ps1 -Version 0.1.0 -DryRun
```
...
- [ ] `scripts/build_release.ps1 -Version 0.1.0` creates the ZIP.
...
- v0.1.0 is not a single executable.
