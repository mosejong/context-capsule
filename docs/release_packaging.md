...
Context Capsule v0.2.11 is distributed as a GitHub Release ZIP.
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\build_release.ps1 -Version 0.2.11 -DryRun
```
...
Release notes: docs/releases/v0.2.11.md
```
...
```text
Download context-capsule-v0.2.11.zip
Extract
...
- [ ] `scripts/build_release.ps1 -Version 0.2.11` creates the ZIP.
...
- v0.2.11 is not a single executable.
