...
Context Capsule v0.2.7 is distributed as a GitHub Release ZIP.
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File scripts\build_release.ps1 -Version 0.2.7 -DryRun
```
...
```text
Download context-capsule-v0.2.7.zip
Extract
...
- [ ] `scripts/build_release.ps1 -Version 0.2.7` creates the ZIP.
...
- v0.2.7 is not a single executable.
