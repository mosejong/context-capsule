...
Use this file when publishing `Context Capsule v0.3.3` on GitHub Releases.
...
Tag: v0.3.3
Title: Context Capsule v0.3.3
Asset: dist/context-capsule-v0.3.3.zip
Release body: docs/releases/v0.3.3.md
```

## Before Upload

- [ ] Confirm `git status -sb` is clean.
- [ ] Confirm tag `v0.3.3` exists on GitHub.
- [ ] Confirm `dist/context-capsule-v0.3.3.zip` exists locally.
- [ ] Confirm ZIP was built with `scripts/build_release.ps1 -Version 0.3.3`.
- [ ] Confirm ZIP excludes `.venv`, `outputs`, `dist`, caches, and credentials.
- [ ] Copy the body from `docs/releases/v0.3.3.md`.
...
3. Select tag `v0.3.3`.
4. Set release title to `Context Capsule v0.3.3`.
5. Paste `docs/releases/v0.3.3.md` into the release description.
6. Upload `dist/context-capsule-v0.3.3.zip`.
7. Check that the asset name is exactly `context-capsule-v0.3.3.zip`.
8. Publish release.
...
- [ ] Confirm `README.md`, `START_HERE_KO.md`, `docs/reference/token_evidence.md`, `docs/reference/workflow_graph.md`, `docs/reference/work_handoff_ownership.md`, `docs/reference/nvidia_nim_provider.md`, `docs/releases/v0.3.3.md`, and `docs/local_app.md` exist.
