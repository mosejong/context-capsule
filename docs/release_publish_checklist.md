...
Use this file when publishing `Context Capsule v0.1.8` on GitHub Releases.
...
Tag: v0.1.8
Title: Context Capsule v0.1.8
Asset: dist/context-capsule-v0.1.8.zip
Release body: docs/releases/v0.1.8.md
```

## Before Upload

- [ ] Confirm `git status -sb` is clean.
- [ ] Confirm tag `v0.1.8` exists on GitHub.
- [ ] Confirm `dist/context-capsule-v0.1.8.zip` exists locally.
- [ ] Confirm ZIP was built with `scripts/build_release.ps1 -Version 0.1.8`.
- [ ] Confirm ZIP excludes `.venv`, `outputs`, `dist`, caches, and credentials.
- [ ] Copy the body from `docs/releases/v0.1.8.md`.
...
3. Select tag `v0.1.8`.
4. Set release title to `Context Capsule v0.1.8`.
5. Paste `docs/releases/v0.1.8.md` into the release description.
6. Upload `dist/context-capsule-v0.1.8.zip`.
7. Check that the asset name is exactly `context-capsule-v0.1.8.zip`.
8. Publish release.
...
- [ ] Confirm `README.md`, `START_HERE_KO.md`, `docs/releases/v0.1.8.md`, and `docs/local_app.md` exist.
