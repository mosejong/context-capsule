...
Use this file when publishing `Context Capsule v0.2.13` on GitHub Releases.
...
Tag: v0.2.13
Title: Context Capsule v0.2.13
Asset: dist/context-capsule-v0.2.13.zip
Release body: docs/releases/v0.2.13.md
```

## Before Upload

- [ ] Confirm `git status -sb` is clean.
- [ ] Confirm tag `v0.2.13` exists on GitHub.
- [ ] Confirm `dist/context-capsule-v0.2.13.zip` exists locally.
- [ ] Confirm ZIP was built with `scripts/build_release.ps1 -Version 0.2.13`.
- [ ] Confirm ZIP excludes `.venv`, `outputs`, `dist`, caches, and credentials.
- [ ] Copy the body from `docs/releases/v0.2.13.md`.

## Publish Steps

1. Open `https://github.com/mosejong/context-capsule/releases`.
2. Click `Draft a new release`.
3. Select tag `v0.2.13`.
4. Set release title to `Context Capsule v0.2.13`.
5. Paste `docs/releases/v0.2.13.md` into the release description.
6. Upload `dist/context-capsule-v0.2.13.zip`.
7. Check that the asset name is exactly `context-capsule-v0.2.13.zip`.
8. Publish release.
...
- [ ] Confirm `README.md`, `START_HERE_KO.md`, `docs/token_evidence.md`, `docs/workflow_graph.md`, `docs/work_handoff_ownership.md`, `docs/releases/v0.2.13.md`, and `docs/local_app.md` exist.
