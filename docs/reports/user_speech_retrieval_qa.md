...
Generated at: 2026-06-25 19:30:33
...
| --- | --- | --- | --- | --- | ---: | --- | --- | --- | --- | --- |
| readme_short | PASS | documentation_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | README.md, docs/reports/user_speech_retrieval_qa.md, docs/releases/v0.2.5.md | OK |
| readme_portfolio | PASS | documentation_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | README.md, docs/reports/user_speech_retrieval_qa.md, docs/releases/v0.2.5.md | OK |
| readme_cleanup | PASS | documentation_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | README.md, docs/reports/user_speech_retrieval_qa.md, docs/releases/v0.2.5.md | OK |
| readme_ko_alias | PASS | documentation_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | README.md, docs/reports/user_speech_retrieval_qa.md, docs/releases/v0.2.5.md | OK |
| docs_summary | PASS | documentation_edit / high | yes | yes | 4 | None | indexed | retrieved_file_contents | README.md, docs/release_publish_checklist.md, docs/reports/user_speech_retrieval_qa.md, docs/releases/v0.1.3.md, docs/v1_roadmap.md | OK |
| docs_portfolio | PASS | documentation_edit / high | yes | yes | 4 | None | indexed | retrieved_file_contents | README.md, docs/reports/user_speech_retrieval_qa.md, docs/releases/v0.2.5.md, docs/request_understanding.md, docs/releases/v0.1.7.md | OK |
...
| github_issue_dry_run | PASS | github_issue_bug_investigation / high | yes | yes | 3 | None | indexed | retrieved_file_contents | app/adapters/github_issue_adapter.py, app/cli.py, docs/local_app.md, scripts/run_dashboard.ps1, scripts/install_windows.ps1 | OK |
...
| local_dashboard_bug | PASS | launcher_bug_investigation / high | no | yes | 1 | None | indexed | retrieved_file_contents | scripts/install_windows.ps1, scripts/run_dashboard.ps1, docs/local_app.md, run_context_capsule.bat | OK |
...
| local_bat_bug | PASS | launcher_bug_investigation / high | no | yes | 1 | None | indexed | retrieved_file_contents | scripts/install_windows.ps1, scripts/run_dashboard.ps1, docs/local_app.md, run_context_capsule.bat | OK |
...
| token_metric_suspicious | PASS | metric_validation / high | no | yes | 3 | None | indexed | retrieved_file_contents | docs/validation.md, docs/reports/performance_comparison.md, scripts/generate_performance_report.py, app/analyzers/token_analyzer.py, docs/reports/user_speech_retrieval_qa.md | OK |
...
| token_reduction_suspicious | PASS | metric_validation / high | no | yes | 3 | None | indexed | retrieved_file_contents | docs/validation.md, docs/reports/performance_comparison.md, scripts/generate_performance_report.py, app/analyzers/token_analyzer.py, docs/reports/user_speech_retrieval_qa.md | OK |
| token_usage_check | PASS | metric_validation / high | no | yes | 3 | None | indexed | retrieved_file_contents | docs/validation.md, docs/reports/performance_comparison.md, scripts/generate_performance_report.py, app/analyzers/token_analyzer.py, docs/reports/user_speech_retrieval_qa.md | OK |
...
| token_analyzer_adapter_hint | PASS | metric_validation / high | no | yes | 3 | None | indexed | retrieved_file_contents | docs/validation.md, docs/reports/performance_comparison.md, scripts/generate_performance_report.py, app/analyzers/token_analyzer.py, docs/reports/user_speech_retrieval_qa.md | OK |
| output_copy | PASS | output_text_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | app/generators/capsule_generator.py, app/generators/output_writer.py, app/main.py, scripts/validate_user_speech.py, app/analyzers/request_understanding.py | OK |
| ai_handoff_copy | PASS | output_text_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | app/generators/capsule_generator.py, app/main.py, app/generators/output_writer.py, scripts/validate_user_speech.py, docs/reports/user_speech_retrieval_qa.md | OK |
| github_issue_output_copy | PASS | output_text_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | app/generators/output_writer.py, app/generators/capsule_generator.py, app/main.py, scripts/validate_user_speech.py, docs/reports/user_speech_retrieval_qa.md | OK |
| metadata_output | PASS | output_text_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | app/generators/capsule_generator.py, app/main.py, app/generators/output_writer.py, scripts/validate_user_speech.py, app/analyzers/request_understanding.py | OK |
| teammate_brief_copy | PASS | output_text_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | app/generators/capsule_generator.py, app/generators/output_writer.py, app/main.py, scripts/validate_user_speech.py, app/analyzers/request_understanding.py | OK |
...
| ram_colab_issue | PASS | runtime_environment_issue / high | no | no | 0 | None | indexed | retrieved_file_contents | app/analyzers/request_understanding.py, scripts/validate_user_speech.py, docs/releases/v0.1.3.md, tests/test_github_issue_adapter.py, docs/research/llm_tech_scan_2026-06-22.md | OK |
...
| check_save_path | PASS | file_output_bug / high | yes | yes | 2 | None | indexed | retrieved_file_contents | docs/local_app.md, app/main.py, app/generators/output_writer.py, scripts/run_dashboard.ps1, run_context_capsule.bat | OK |
...
| timeout_generation | PASS | timeout_issue / high | no | no | 0 | None | indexed | retrieved_file_contents | scripts/validate_user_speech.py, app/analyzers/request_understanding.py, app/retrievers/simple_retriever.py, docs/releases/v0.1.2.md, app/generators/feedback_template_generator.py | OK |
...
| protect_jwt_readme | PASS | documentation_edit / high | yes | yes | 4 | auth | indexed | retrieved_file_contents | README.md, docs/reports/user_speech_retrieval_qa.md, docs/releases/v0.2.5.md, docs/request_understanding.md, docs/releases/v0.1.7.md | OK |
