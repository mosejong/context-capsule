...
Generated at: 2026-06-25 09:16:23
...
| docs_summary | PASS | documentation_edit / high | yes | yes | 4 | None | indexed | retrieved_file_contents | README.md, docs/release_publish_checklist.md, docs/reports/user_speech_retrieval_qa.md, docs/releases/v0.1.3.md, docs/vision.md | OK |
...
| image_black_screen | PASS | media_render_bug / high | no | no | 0 | None | indexed | retrieved_file_contents | app/main.py, app/analyzers/request_understanding.py, app/services/doctor_service.py, scripts/validate_user_speech.py, docs/reports/user_speech_retrieval_qa.md | OK |
...
| protect_auth_docs_only | PASS | documentation_edit / high | yes | yes | 4 | auth | indexed | retrieved_file_contents | README.md, docs/release_publish_checklist.md, docs/reports/user_speech_retrieval_qa.md, docs/releases/v0.1.3.md, docs/vision.md | OK |
...
| protect_deploy_docs | PASS | documentation_edit / high | yes | yes | 4 | deploy | indexed | retrieved_file_contents | README.md, docs/release_publish_checklist.md, docs/reports/user_speech_retrieval_qa.md, docs/releases/v0.1.3.md, docs/vision.md | OK |
