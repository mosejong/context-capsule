...
Generated at: 2026-06-25 09:57:51
...
| script_review | PASS | presentation_review / high | yes | yes | 3 | None | indexed | retrieved_file_contents | docs/v0.2_scrum_kickoff_modes.md, app/analyzers/meeting_analyzer.py, docs/reports/user_speech_retrieval_qa.md, README.md, docs/release_publish_checklist.md | OK |
| add_eval_report | PASS | presentation_review / high | yes | yes | 3 | None | indexed | retrieved_file_contents | docs/v0.2_scrum_kickoff_modes.md, app/analyzers/meeting_analyzer.py, docs/reports/user_speech_retrieval_qa.md, README.md, docs/release_publish_checklist.md | OK |
...
| zoom_audio_low | PASS | presentation_environment_issue / high | yes | yes | 3 | None | indexed | retrieved_file_contents | docs/v0.2_scrum_kickoff_modes.md, app/analyzers/meeting_analyzer.py, docs/reports/user_speech_retrieval_qa.md, README.md, docs/release_publish_checklist.md | OK |
| share_audio_missing | PASS | presentation_environment_issue / high | yes | yes | 3 | None | indexed | retrieved_file_contents | docs/v0.2_scrum_kickoff_modes.md, app/analyzers/meeting_analyzer.py, docs/reports/user_speech_retrieval_qa.md, README.md, docs/release_publish_checklist.md | OK |
| ppt_script_mismatch | PASS | presentation_review / high | yes | yes | 3 | None | indexed | retrieved_file_contents | docs/v0.2_scrum_kickoff_modes.md, app/analyzers/meeting_analyzer.py, docs/reports/user_speech_retrieval_qa.md, README.md, docs/release_publish_checklist.md | OK |
| slide_page_edit | PASS | media_render_bug / high | yes | yes | 3 | None | indexed | retrieved_file_contents | docs/v0.2_scrum_kickoff_modes.md, app/analyzers/meeting_analyzer.py, docs/reports/user_speech_retrieval_qa.md, README.md, docs/release_publish_checklist.md | OK |
| presentation_polish | PASS | presentation_review / high | yes | yes | 3 | None | indexed | retrieved_file_contents | docs/v0.2_scrum_kickoff_modes.md, app/analyzers/meeting_analyzer.py, docs/reports/user_speech_retrieval_qa.md, README.md, docs/release_publish_checklist.md | OK |
