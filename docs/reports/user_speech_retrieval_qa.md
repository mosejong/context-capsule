...
| performance_report_check | PASS | metric_validation / high | yes | yes | 3 | None | indexed | retrieved_file_contents | scripts/generate_performance_report.py, docs/validation.md, docs/reports/performance_comparison.md, app/analyzers/token_analyzer.py, docs/token_evidence.md | OK |
