...
Generated at: 2026-06-24 16:06:51
...
| --- | --- | --- | --- | --- | ---: | --- | --- | --- | --- | --- |
| readme_short | PASS | documentation_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | README.md, local-ko/README.md, docs/reports/user_speech_retrieval_qa.md | OK |
| readme_portfolio | PASS | documentation_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | README.md, local-ko/README.md, docs/reports/user_speech_retrieval_qa.md | OK |
| readme_cleanup | PASS | documentation_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | README.md, local-ko/README.md, docs/reports/user_speech_retrieval_qa.md | OK |
| readme_ko_alias | PASS | documentation_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | README.md, local-ko/README.md, docs/reports/user_speech_retrieval_qa.md | OK |
| docs_summary | PASS | documentation_edit / high | yes | yes | 4 | None | indexed | retrieved_file_contents | README.md, docs/releases/v0.1.3.md, docs/reports/user_speech_retrieval_qa.md, docs/release_publish_checklist.md, docs/vision.md | OK |
| docs_portfolio | PASS | documentation_edit / high | yes | yes | 4 | None | indexed | retrieved_file_contents | README.md, local-ko/README.md, docs/reports/user_speech_retrieval_qa.md, local-ko/05_흐름도.md, docs/request_understanding.md | OK |
...
| token_metric_suspicious | PASS | metric_validation / high | no | yes | 3 | None | indexed | retrieved_file_contents | docs/validation.md, scripts/generate_performance_report.py, docs/reports/performance_comparison.md, app/analyzers/token_analyzer.py, docs/reports/user_speech_retrieval_qa.md | OK |
| token_budget_bug | PASS | metric_validation / high | no | yes | 3 | None | indexed | retrieved_file_contents | docs/validation.md, scripts/generate_performance_report.py, docs/reports/performance_comparison.md, app/analyzers/token_analyzer.py, docs/reports/user_speech_retrieval_qa.md | OK |
| token_reduction_suspicious | PASS | metric_validation / high | no | yes | 3 | None | indexed | retrieved_file_contents | docs/validation.md, scripts/generate_performance_report.py, docs/reports/performance_comparison.md, app/analyzers/token_analyzer.py, docs/reports/user_speech_retrieval_qa.md | OK |
| token_usage_check | PASS | metric_validation / high | no | yes | 3 | None | indexed | retrieved_file_contents | docs/validation.md, scripts/generate_performance_report.py, docs/reports/performance_comparison.md, app/analyzers/token_analyzer.py, docs/reports/user_speech_retrieval_qa.md | OK |
| performance_report_check | PASS | metric_validation / high | no | yes | 3 | None | indexed | retrieved_file_contents | docs/validation.md, scripts/generate_performance_report.py, docs/reports/performance_comparison.md, app/analyzers/token_analyzer.py, docs/reports/user_speech_retrieval_qa.md | OK |
| token_analyzer_adapter_hint | PASS | metric_validation / high | no | yes | 3 | None | indexed | retrieved_file_contents | docs/validation.md, scripts/generate_performance_report.py, docs/reports/performance_comparison.md, app/analyzers/token_analyzer.py, docs/reports/user_speech_retrieval_qa.md | OK |
| output_copy | PASS | output_text_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | app/generators/output_writer.py, app/main.py, app/generators/capsule_generator.py, docs/reports/user_speech_retrieval_qa.md, app/analyzers/request_understanding.py | OK |
| ai_handoff_copy | PASS | output_text_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | app/generators/output_writer.py, app/main.py, app/generators/capsule_generator.py, docs/reports/user_speech_retrieval_qa.md, app/analyzers/request_understanding.py | OK |
| github_issue_output_copy | PASS | output_text_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | app/generators/output_writer.py, app/main.py, app/generators/capsule_generator.py, docs/reports/user_speech_retrieval_qa.md, app/analyzers/request_understanding.py | OK |
| metadata_output | PASS | output_text_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | app/generators/output_writer.py, app/main.py, app/generators/capsule_generator.py, docs/reports/user_speech_retrieval_qa.md, app/analyzers/request_understanding.py | OK |
| teammate_brief_copy | PASS | output_text_edit / high | yes | yes | 2 | None | indexed | retrieved_file_contents | app/generators/output_writer.py, app/main.py, app/generators/capsule_generator.py, docs/reports/user_speech_retrieval_qa.md, app/analyzers/request_understanding.py | OK |
...
| kickoff_scope | PASS | project_kickoff / high | yes | yes | 2 | None | indexed | retrieved_file_contents | app/analyzers/meeting_analyzer.py, docs/reports/user_speech_retrieval_qa.md, app/cli.py | OK |
| kickoff_mvp | PASS | project_kickoff / high | yes | yes | 2 | None | indexed | retrieved_file_contents | app/analyzers/meeting_analyzer.py, docs/reports/user_speech_retrieval_qa.md, app/cli.py | OK |
| kickoff_contest_checklist | PASS | project_kickoff / high | yes | yes | 2 | None | indexed | retrieved_file_contents | app/analyzers/meeting_analyzer.py, docs/reports/user_speech_retrieval_qa.md, app/cli.py | OK |
...
| generated_but_not_saved | PASS | file_output_bug / high | yes | yes | 2 | None | indexed | retrieved_file_contents | docs/local_app.md, app/generators/output_writer.py, app/main.py, scripts/run_dashboard.ps1, scripts/install_windows.ps1 | OK |
| check_save_path | PASS | file_output_bug / high | yes | yes | 2 | None | indexed | retrieved_file_contents | docs/local_app.md, app/generators/output_writer.py, app/main.py, scripts/run_dashboard.ps1, scripts/install_windows.ps1 | OK |
...
| demo_video_saved | PASS | file_output_bug / high | yes | yes | 2 | None | indexed | retrieved_file_contents | docs/local_app.md, docs/v0.2_scrum_kickoff_modes.md, app/main.py, app/generators/output_writer.py, app/analyzers/meeting_analyzer.py | OK |
...
| slide_page_edit | PASS | media_render_bug / high | yes | yes | 3 | None | indexed | retrieved_file_contents | app/analyzers/meeting_analyzer.py, docs/v0.2_scrum_kickoff_modes.md, docs/reports/user_speech_retrieval_qa.md, README.md, docs/v1_roadmap.md | OK |
...
| rehearsal_schedule | PASS | presentation_review / high | yes | yes | 3 | None | indexed | retrieved_file_contents | docs/v0.2_scrum_kickoff_modes.md, app/analyzers/meeting_analyzer.py, docs/reports/user_speech_retrieval_qa.md, docs/v1_roadmap.md, README.md | OK |
| protect_auth_docs_only | PASS | documentation_edit / high | yes | yes | 4 | auth | indexed | retrieved_file_contents | README.md, docs/releases/v0.1.3.md, docs/reports/user_speech_retrieval_qa.md, docs/release_publish_checklist.md, docs/vision.md | OK |
| protect_db_output_copy | PASS | output_text_edit / high | yes | yes | 2 | db | indexed | retrieved_file_contents | app/generators/output_writer.py, app/main.py, app/generators/capsule_generator.py, docs/reports/user_speech_retrieval_qa.md, app/analyzers/request_understanding.py | OK |
| protect_jwt_readme | PASS | documentation_edit / high | yes | yes | 4 | auth | indexed | retrieved_file_contents | README.md, local-ko/README.md, docs/reports/user_speech_retrieval_qa.md, local-ko/05_흐름도.md, docs/request_understanding.md | OK |
| protect_secret_token_report | PASS | metric_validation / high | no | yes | 3 | secret | indexed | retrieved_file_contents | docs/validation.md, scripts/generate_performance_report.py, docs/reports/performance_comparison.md, app/analyzers/token_analyzer.py, docs/reports/user_speech_retrieval_qa.md | OK |
...
| protect_deploy_docs | PASS | documentation_edit / high | yes | yes | 4 | deploy | indexed | retrieved_file_contents | README.md, docs/releases/v0.1.3.md, docs/reports/user_speech_retrieval_qa.md, docs/release_publish_checklist.md, docs/vision.md | OK |
| protect_db_output | PASS | output_text_edit / high | yes | yes | 2 | db | indexed | retrieved_file_contents | app/generators/output_writer.py, app/main.py, app/generators/capsule_generator.py, docs/reports/user_speech_retrieval_qa.md, app/analyzers/request_understanding.py | OK |
