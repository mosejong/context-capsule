...
st.warning(
    "이 화면은 Streamlit legacy/prototype UI입니다. v0.3.1 기본 테스터 UI는 "
...
def render_scrum_mode() -> None:
    ...
    project_context = st.text_input("Optional project context", value="Context Capsule v0.3.1 planning")
...
def render_kickoff_mode() -> None:
    ...
    topic = st.text_input("Project / contest topic", value="Context Capsule v0.3.1 for scrum-to-execution planning")
